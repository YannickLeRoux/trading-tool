...
var StocksScreener = (function () {
    ...
    StocksScreener.prototype.isBullshit = function () {
    };
...
polishData(data);
{
    var polished_1 = alpha.util.polish(data);
    var dataArray = Object.keys(polished_1.data).map(function (key) {
        var _a;
        return (_a = {},
            _a[key] = polished_1.data[key],
            _a);
    });
    return dataArray;
}
